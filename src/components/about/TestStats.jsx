        ...
        <div className="lg:mx-8 lg:grid lg:max-w-full lg:grid-cols-2 lg:items-start lg:gap-24 lg:px-8">
          <div className="relative sm:py-16 lg:py-0">
            ...
            <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:max-w-none lg:px-0 lg:py-20">
              ...
              <div className="relative overflow-hidden rounded-2xl pt-64 pb-10 shadow-xl">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-orange-button via-orange-button opacity-90" />
                <div className="relative px-8">
                  ...
                  <blockquote className="mt-8">
                    <div className="relative text-lg font-medium text-white md:flex-grow">
                      <svg
                        className="absolute top-0 left-0 h-8 w-8 -translate-x-3 -translate-y-2 transform text-orange-400"
                        fill="currentColor"
                        viewBox="0 0 32 32"
                        aria-hidden="true"
                      >
          ...
          <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
            ...
            <div className="mt-10">
              ...
              <div className="mt-10">
                <a href="#" className="text-base font-medium text-orange-button">
