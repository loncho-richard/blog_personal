...
import codificacion from 'assets/img/services/codificacion.png'
...
function Services(){
    ...
    return(
        <Layout>
          <Helmet>
                <title>Vaifax | Software Services</title>
            ...
            <div className="pt-28">
                ...
                <ServicesList posts={posts_desing} section_title={"Desing Services"}/>
            </div>
            <Footer />
        </Layout>
    );
